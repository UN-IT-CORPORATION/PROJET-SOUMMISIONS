...
import { getInvitedSubmissionColumns } from "./columns"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"

export function InvitedProjectViewSubmissionsPage() {
    ...
    const columns = React.useMemo(() => getInvitedSubmissionColumns(t), [t])
