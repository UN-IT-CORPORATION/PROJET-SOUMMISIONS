...
export function ProjectsPage() {
    ...
    const columns = React.useMemo(() => getProjectColumns(t), [t])
    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h1 className="text-xl font-bold text-gray-900 mb-2">{t("sidebar.my_projects")}</h1>
                    <DynamicBreadcrumb />
                </div>
            </div>
            <DataTable
                ...
                topRightAction={
                    <Button className="gap-2 cursor-pointer" onClick={() => navigate({ to: "/projects/add/step-1" })}>
